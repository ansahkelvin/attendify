...
//
//
// const credentials = new msRest.ApiKeyCredentials({ inHeader: { 'Ocp-Apim-Subscription-Key': "067ec35371ed4683a022ee9387e3dc4d" } });
// const client = new Face.FaceClient(credentials, "https://group4aiproject.cognitiveservices.azure.com/");
//
//
//
...
//         });
//     return detected_faces.filter(face => {
...
// }
//
// async function WaitForPersonGroupTraining(person_group_id: string) {
